...
- Send WhatsApp message via http API, [docs/openapi.yml](openapi.yaml) for more details
...
- Webhook for received message
  ...
  - for more detail, see [Webhook Payload Documentation](webhook-payload.md)
- Webhook Secret
...
- **Webhook Payload Documentation**
  ...
  see [Webhook Payload Documentation](webhook-payload.md)
...
- Check [docs/openapi.yml](openapi.yaml) for detailed API specifications.
